...
class ProtocolKtTest: Asserter {
    ...
    fun testMultiplicationProtocol(){
        ...
        val executionTimeEncMultOnlyOnes = measureTimeMillis {
        ...
        println("Execution time (resolve XOnlyOnes with multiplicationProtocol) : $executionTimeEncMultOnlyOnes ms")

        val executionTimeEncMultOneAndaZero = measureTimeMillis {
        ...
        println("Execution time (resolve XOnesAndaZero with multiplicationProtocol) : $executionTimeEncMultOneAndaZero ms")
